...
#############
  ...
  idx <- NV1$IdVenta[NV1$Sub_Zona_N1V %in% c("27.6","27.7")]
  DB1$Metier[DB1$IdVenta %in% idx]  <-  "OTB_DEF_100-119_0_0"
  NV1$Metier[NV1$IdVenta %in% idx]  <-  "OTB_DEF_100-119_0_0" 
  LN1$Arte[LN1$IdVenta %in% idx]    <-  "OTB_DEF_100-119_0_0"
