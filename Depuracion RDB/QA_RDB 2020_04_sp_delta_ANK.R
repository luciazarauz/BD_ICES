...
#seleccionamos un metier
 ...
 for(metier in list( c("OTB_DEF_>=70_0_0", "OTB_MCF_>=70_0_0"), "PTB_MPD_>=55_0_0", "GTR_DEF_60-79_0_0"))  {
 

  #metier <- c("PTB_MPD_>=55_0_0" )
  #metier <- c("OTB_DEF_>=70_0_0", "OTB_MCF_>=70_0_0" )
  #metier <- c("GTR_DEF_60-79_0_0")

  list(c("PS_SPF_0_0_0", "PTB_MPD_>=55_0_0"), "OTB_DEF_>=70_0_0" ,"GNS_DEF_60-79_0_0" ,"LHM_SPF_0_0_0" )
